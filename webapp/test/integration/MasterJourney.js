...
sap.ui.define([
	...
	opaTest("MasterList Filtering on SALARY less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<SALARY>").
	...
	opaTest("MasterList Filtering on SALARY more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <>").
			and.iPressOKInViewSelectionDialog();
