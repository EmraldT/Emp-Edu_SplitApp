sap.ui.define([
		...
		return BaseObject.extend("employee.detail.Employee.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias employee.detail.Employee.controller.ListSelector
			 */
			 ...
			 * @return {employee.detail.Employee.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
