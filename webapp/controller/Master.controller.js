...
sap.ui.define([
		...
		"employee/detail/Employee/model/grouper",
		...
		return BaseController.extend("employee.detail.Employee.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("employee.detail.Employee.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("SALARY", FilterOperator.LE, 30000));
							break;
						case "Filter2" :
							aFilters.push(new Filter("SALARY", FilterOperator.GT, 30000));
							break;
						default :
							break;
					}
			...
			onAddMaster: function(){
				var sLastItemId,
					oItemTitles = [],
					oItems = this._oList.getItems();
					for(var i=0;i<oItems.length;i++){
						oItemTitles.push((oItems[i].getProperty("title")*1));
					}
					oItemTitles.sort(function(a, b){return a - b;});
					sLastItemId = oItemTitles[oItemTitles.length - 1] + 1;
				this.getRouter().navTo("addMaster",{ID : sLastItemId});
			},
